...
namespace Light2D
{
    ...
    public class LightingSystem : MonoBehaviour
    {
        ...
        public static bool IsSceneViewFocused
        {
            get
            {
                return UnityEditor.SceneView.currentDrawingSceneView != null &&
                       UnityEditor.SceneView.currentDrawingSceneView == UnityEditor.EditorWindow.focusedWindow;
            }
        }
#endif
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError(
                    "Lighting Camera cannot be initialized");
                enabled = false;
                return;
            }
            ...
            {
                Debug.LogError("Perspective mode does not supported");
                return;
            }
        ...
        {
#if UNITY_EDITOR
            if (!Application.isPlaying || IsSceneViewFocused)
            {
                Shader.SetGlobalTexture("_ObstacleTex", Texture2D.whiteTexture);
                if (dest != null)
 ...
 */
        ...
        private void RenderLightSources()
        {
            ...
            //     foreach (var lightSprite in LightSpriteTestLightSprits)
            //     {
